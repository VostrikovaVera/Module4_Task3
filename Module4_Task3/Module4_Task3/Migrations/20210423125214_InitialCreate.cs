    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 2, new DateTime(1985, 1, 31, 0, 0, 0, 0, DateTimeKind.Unspecified), "Rachel", new DateTime(2018, 1, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "Green", 1, 1 });

            migrationBuilder.InsertData(
                table: "Employee",
                columns: new[] { "EmployeeId", "DateOfBirth", "FirstName", "HiredDate", "LastName", "OfficeId", "TitleId" },
                values: new object[] { 1, new DateTime(1975, 4, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), "Ross", new DateTime(2020, 4, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), "Geller", 2, 3 });
